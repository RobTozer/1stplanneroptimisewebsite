      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-8 text-center">Featured Video Testimonial - The Learners' Trust</h2>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative" style={{ aspectRatio: "16/10" }}>
                <video
                  ...
                  preload="metadata"
                  poster="/placeholder.svg?height=600&width=1000&query=matt+freeston+learners+trust+ceo+interview"
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl">Matt Freeston</h3>
                    <p className="text-sm text-gray-600">CEO, The Learners' Trust</p>
                  </div>
                </div>
                <blockquote className="text-gray-700 italic mb-6">
                  "Working with 1st Planner, they have used huge data sets and identified where capacity is both inside
                  our schools and across our estates. They have identified finances and opportunities for us to develop
                  those estates and the resulting plan has been really clear. It has identified not only positives and
                  opportunities across our trust but also for our Local Authorities particularly where it comes to SEND
                  provision and sufficiency. We are now getting the opportunity to work closely with our Local
                  Authorities to help the most vulnerable and needs children we have. 1st Planner have been really good
                  at identifying the 1st stages of the plans and helping us engage with people from the DfE, Local
                  Authority and industry partners to try and get things moving forwards and we have a really clear
                  pathway What they do really works, it does adds huge capacity to the work of the Trust and delivers
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <blockquote className="text-gray-700 italic mb-6">
                  "The partnership between the City of Wolverhampton Council and 1st Planner has successfully supported
                  our evidenced based approach to school place planning. The series of bespoke products provided by 1st
                  Planner offer a great starting point to both maximise the use of existing facilities and support the
                  development of future plans."
                </blockquote>
                <p className="font-semibold">Dave Kirby</p>
                <p className="text-sm text-gray-500">Service Manager, School Organisation and Support</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-500">Head of Diocesan Property</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <blockquote className="text-gray-700 italic mb-6">
                  "Optimise, has been incredibly insightful in our exploration of supporting other local authorities and
                  schools. It allows us to easily decode data to make strategic decisions, we have been physically given
                  the information rather than having to use internal time and resources searching for it. Previously we
                  will have had many unknowns and be left with unanswered questions; this technology provides our team
                  and board with the confidence to proceed with working with specific organisations that we wouldn't
                  have had the confidence to work with in the past."
                </blockquote>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-500">Head of Estates & Facilities Management</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-[#0a0a5e] text-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8">
              Contact us today to discuss how our optimization services can help you create high-quality educational
              spaces while maximizing your resources.
            </p>
