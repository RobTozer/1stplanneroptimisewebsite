  ...
  return (
    <>
      ...
      <section className="relative bg-[#0a0a5e] text-white">
        ...
        <div className="container relative z-10 py-12 md:py-20 lg:py-32">
          <div className="text-container text-center">
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 font-heading leading-tight">
              Strategic Education Population and Asset Planning
            </h1>
            ...
            <div className="flex justify-center">
              <Button asChild size="lg" className="bg-white text-[#0a0a5e] hover:bg-gray-200 px-6 md:px-8">
      ...
      <section id="services" className="py-12 md:py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-8 md:mb-12 content-container">
            ...
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4 text-container font-heading leading-tight">
              Moving from Reactive to Proactive School Planning: How Education Leaders Are Reclaiming Control with Data
            </h2>
            <div className="text-container">
              <p className="text-sm md:text-base lg:text-lg text-gray-600 mb-3 md:mb-4 text-center leading-relaxed">
              ...
              <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4 mt-4 md:mt-6 font-heading">
                We've Built a Better Way
              </h3>
              <p className="text-sm md:text-base lg:text-lg text-gray-600 mb-3 md:mb-4 text-center leading-relaxed">
                At 1st Planner, we work with school system leaders across England who are determined to do things
                differently. Leaders who want to move from guesswork to grounded strategy. "Optimise" is our answer to
                the complex, high-stakes challenge of strategic planning for school populations and estates. It's a
                fully dynamic suite of Power BI dashboards that turns disconnected and irregular data into one clear,
                connected picture.
              </p>
              <p className="text-sm md:text-base lg:text-lg text-gray-600 mb-6 md:mb-8 text-center leading-relaxed">
                We provide specialised optimisation services for different education providers, helping them make the
                most of their resources and spaces:
              </p>
            </div>
          </div>

          <div className="content-container">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 text-center">
              {/* LA Optimise */}
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 font-heading">What Our Clients Say</h2>
            <p className="text-base md:text-lg text-gray-600 narrow-container leading-relaxed">
              Hear from the education providers we've helped to optimise their spaces and resources.
            </p>
          </div>

          <div className="text-container bg-gray-50 p-6 md:p-8 rounded-lg shadow-sm">
            ...
            <div className="mt-4 md:mt-6 flex items-center">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm md:text-base">
                TG
              </div>
              <div className="ml-3 md:ml-4">
                <p className="font-semibold text-sm md:text-base">Toni Guest</p>
                <p className="text-xs md:text-sm text-gray-500">Head of Diocesan Property, Archdiocese of Birmingham</p>
              </div>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-16 bg-[#0a0a5e] text-white">
        <div className="container">
          <div className="narrow-container text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 font-heading">
              Ready to Optimise Your Education and Wider Estate?
            </h2>
