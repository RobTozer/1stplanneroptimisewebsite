    ...
    <>
      ...
      <section id="services" className="py-12 md:py-16 bg-gray-50">
        <div className="container px-4">
          <div className="text-center mb-8 md:mb-12 max-w-screen-lg mx-auto">
            ...
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4 max-w-4xl mx-auto font-heading leading-tight">
              Moving from Reactive to Proactive School Planning: How Education Leaders Are Reclaiming Control with Data
            </h2>
            <p className="text-sm md:text-base lg:text-lg text-gray-600 max-w-4xl mx-auto mb-3 md:mb-4 text-center leading-relaxed">
            ...
            <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-3 md:mb-4 max-w-4xl mx-auto mt-4 md:mt-6 font-heading">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-600 max-w-4xl mx-auto mb-6 md:mb-8 text-center leading-relaxed">
